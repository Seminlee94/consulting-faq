...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { consultant_id: @assignment.consultant_id, question_id: @assignment.question_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { consultant_id: @assignment.consultant_id, question_id: @assignment.question_id } }
