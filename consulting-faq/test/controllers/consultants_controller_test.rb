...
class ConsultantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultant" do
    assert_difference('Consultant.count') do
      post consultants_url, params: { consultant: { email: @consultant.email, expertise: @consultant.expertise, name: @consultant.name } }
    end
  ...
  test "should update consultant" do
    patch consultant_url(@consultant), params: { consultant: { email: @consultant.email, expertise: @consultant.expertise, name: @consultant.name } }
